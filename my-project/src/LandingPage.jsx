        ...
        <footer className="border-t pt-16 md:pt-20 pb-10 px-6 md:px-12 mb-0 theme-transition" style={{ borderColor: 'var(--border-color)', backgroundColor: 'var(--bg-main)' }}>
          <div className="flex flex-col gap-12 mb-16 md:mb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
                ...
                <div className="flex flex-col gap-4"><h4 className="font-bold text-xs uppercase" style={{ color: 'var(--text-muted)' }}>Company</h4><a href="#" className="hover:opacity-100 opacity-60 interactive">Terms</a><a href="#" className="hover:opacity-100 opacity-60 interactive">Privacy</a></div>
