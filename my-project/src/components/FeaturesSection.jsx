...
export default function FeaturesSection() {
  return (
    <section className="py-20 bg-[#FDF1E6]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          
          {/* Left Side: Images in a dynamic, overlapping Collage */}
          <div className="relative h-[550px] w-full max-w-lg mx-auto md:max-w-none md:h-[600px] group">
          ...
          <div className="space-y-6 pl-0 lg:pl-10">
            ...
            <div className="mb-12">
              <h2 className="text-4xl lg:text-5xl font-serif text-[#5c3a21] mb-4">Why Choose Us?</h2>
              {/* Correct broad text for all customized gifts */}
              <p className="text-gray-600 text-xl font-light">We craft memories through our unique customized gifts. Here is what makes us special.</p>
            </div>
            
            {/* Feature 1: Premium Quality (Updated Icon from previous turn) */}
            <div className="flex items-start group p-4 -ml-4 rounded-2xl hover:bg-white/40 transition-colors duration-300">
              <div className="flex-shrink-0 flex items-center justify-center w-16 h-16 rounded-full bg-[#f3e6d8] text-[#5c3a21] transition-all duration-300 group-hover:scale-110 group-hover:bg-[#5c3a21] group-hover:text-white shadow">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                </svg>
              </div>
              <div className="ml-6 mt-1">
                <h3 className="text-2xl font-serif text-[#5c3a21]">Premium Quality</h3>
                <p className="mt-2 text-gray-600 text-lg">Crafted with love and high-quality materials</p>
              </div>
            </div>
            ...
            <div className="flex items-start group p-4 -ml-4 rounded-2xl hover:bg-white/40 transition-colors duration-300">
              ...
              <div className="ml-6 mt-1">
                <h3 className="text-2xl font-serif text-[#5c3a21]">Top-notch support</h3>
                <p className="mt-2 text-gray-600 text-lg">24x7 Customer Support</p>
              </div>
            </div>
            ...
            <div className="flex items-start group p-4 -ml-4 rounded-2xl hover:bg-white/40 transition-colors duration-300">
              ...
              <div className="ml-6 mt-1">
                <h3 className="text-2xl font-serif text-[#5c3a21]">Secure Payment</h3>
                <p className="mt-2 text-gray-600 text-lg">24 hours a day, 7 days a week</p>
              </div>
            </div>
